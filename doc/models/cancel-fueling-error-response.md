...
|  --- | --- | --- | --- |
| `error_code` | `String` | Optional | The high level error code (e.g. missing data) |
| `error_description` | `String` | Optional | The high level error message (e.g. mandatory fields have not been specified. |
| `errors` | [`Array<MppError>`](../../doc/models/mpp-error.md) | Optional | Array of error objects. Majority of the time the errorCode and errorDescription will suffice |
